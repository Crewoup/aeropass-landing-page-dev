...
function createToast(data) {
    ...
    toast.className = 'glass-card p-4 rounded-xl flex items-center gap-4 min-w-[320px] max-w-sm border-l-4 border-aero-yellow shadow-2xl backdrop-blur-xl bg-slate-900/80 toast-enter';
    
    toast.innerHTML = `
        <div class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center ${data.color} font-bold border border-white/10 shadow-inner">
