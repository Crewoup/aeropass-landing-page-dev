...
- **SEO 基礎設定**：
    - Title: AeroPass - AI Check Airman Interview Prep
    - Description: Master your pilot interview with AI-powered simulations. Real-time feedback on technical knowledge and HR scenarios.
    - OG Image: (預留 OG Image 連結)
...
- **輸入區：**
    - **主要動作：** 一個巨大、誘人的麥克風按鈕 `[ 🎙️ Hold to Speak (按住說話) ]`。
        - **Mobile 特別考量**：在手機版，請將此麥克風按鈕設計為固定在螢幕底部的操作列，方便單手按住操作。
...
### Section 3: Why AeroPass? (核心優勢)

此區塊在使用者體驗完 Magic Moment 後，理性強化產品價值。

- **AI Check Airman Standard**: "Feedback calibrated to real airline grading matrices." (對標真實航空公司評分矩陣的 AI 回饋。)
- **Global Question Bank**: "Crowdsourced and verified scenarios from 50+ major airlines." (來自 50+ 家主要航空公司的群眾外包與驗證題庫。)
- **Anytime, Anywhere**: "Practice your verbal callouts in the car, or technical knowledge on the jumpseat." (在車上練習口令，或在 Jumpseat 上複習技術知識。)

### Section 4: Static Social Proof (靜態信任背書)

- 標題： Trusted by pilots from
- 內容：一排單色（灰色或微透明）的航空公司 Logo 或文字列表（例如：Emirates, Cathay Pacific, EVA Air, Delta, etc.），展示使用者來源，建立權威感。

### Footer (頁尾)

- Copyright © 2024 AeroPass. All rights reserved.
